...
### Features
 ...
 - mc_temt: TileEntity Multi-Threading support. Powered By [Black Magic](https://www.youtube.com/watch?v=dQw4w9WgXcQ). Copied from [MCMTFabric](https://github.com/himekifee/MCMTFabric). **NEVER ENABLE THIS ON CLIENT** (Defaults:OFF)
...
Take a look at the examples in [`tech.paulzzh.mygtnh.mixinplugin.*`](https://github.com/SinTh0r4s/ExampleMod1.7.10/tree/example-mixins/src/main/java/com/myname/mymodid/mixinplugin) and [`tech.paulzzh.mygtnh.mixins.*`](https://github.com/SinTh0r4s/ExampleMod1.7.10/tree/example-mixins/src/main/java/com/myname/mymodid/mixins). 
